...
import versus_img from "../assets/Register/test.jpg";
import logo from "../assets/Register/11.jpg"
    ...
    <div className="flex flex-row h-screen w-full">
      <section className="bg-gradient-to-bl from-violet-50 to-violet-400 w-[50%]">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          ...
          >
            <img class="w-16 h-16 mr-2 rounded-full" src={logo} alt="logo"/>
            Fantasy 11
          </a>
      ...
      <div className="w-[50%] flex flex-col items-center gap-10">
        ...
        <p className="text-4xl font-rubik text-violet-800 font-extrabold">CREATE YOUR BOUNTY 11 NOW !</p>
      </div>
    </div>
  );
};
